  ...
  if ((Efer & IA32_EFER_MSR_MLA) != 0) {
    ...
    if (sizeof(UINTN) == sizeof(UINT64)) {
      ...
      if ((L4PageTable[Index4] & IA32_PG_P) == 0) {
		DEBUG ((EFI_D_ERROR, "EPA-RIMM-Inspector:TranslateGuestLinearToPhysical returning 0, case 0\n"));
        return 0;
      }

      L3PageTable = (UINT64 *)(UINTN)(L4PageTable[Index4] & Paging4kAddressMask64);
      if ((L3PageTable[Index3] & IA32_PG_P) == 0) {
		DEBUG ((EFI_D_ERROR, "EPA-RIMM-Inspector:TranslateGuestLinearToPhysical returning 0, case 1\n"));
        return 0;
      }

      L2PageTable = (UINT64 *)(UINTN)(L3PageTable[Index3] & Paging4kAddressMask64);
      if ((L2PageTable[Index2] & IA32_PG_P) == 0) {
		DEBUG ((EFI_D_ERROR, "EPA-RIMM-Inspector:TranslateGuestLinearToPhysical returning 0, case 2\n"));
        return 0;
      }
      ...
      if ((L2PageTable[Index2] & IA32_PG_PS) != 0) {
        ...
        if ((L1PageTable[Index1] & IA32_PG_P) == 0) {
		  DEBUG ((EFI_D_ERROR, "EPA-RIMM-Inspector:TranslateGuestLinearToPhysical returning 0, case 3\n"));
          return 0;
        }
      ...
      Index4 = 0;
      L4PageTable = NULL;
	  DEBUG ((EFI_D_ERROR, "EPA-RIMM-Inspector:TranslateGuestLinearToPhysical returning 0, case 4\n"));
      return 0;
    }
  } else {
    if (Ia32e != NULL) {
    ...
    if ((Cr0 & CR0_PG) != 0) {
      ...
      if ((Cr4 & CR4_PAE) != 0) {
        ...
        if ((L3PageTable[Index3] & IA32_PG_P) == 0) {
		  DEBUG ((EFI_D_ERROR, "EPA-RIMM-Inspector:TranslateGuestLinearToPhysical returning 0, case 5\n"));
          return 0;
        }

        L2PageTable = (UINT64 *)(UINTN)(L3PageTable[Index3] & Paging4kAddressMask64);
        if ((L2PageTable[Index2] & IA32_PG_P) == 0) {
          DEBUG ((EFI_D_ERROR, "EPA-RIMM-Inspector:TranslateGuestLinearToPhysical returning 0, case 6\n"));
          return 0;
        }
